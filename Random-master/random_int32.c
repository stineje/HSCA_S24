...
uint32_t hex2uint32 (const unsigned char *str) {
...
int main(void) {
  ...
  for (j = 0; j < NUMB; j++) {
    ...
    number1 = (int32_t) hex2uint32(str1);
    number2 = (int32_t) hex2uint32(str2);
    number1u = hex2uint32(str1);
    number2u = hex2uint32(str2);
